...
describe('calculator functionality', function() {
  ...
  it('should update the running total on button click', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should be able to clear the running total without affecting calculation', function(){
    running_total = element(by.css('#running_total'))
    element(by.css('#number2')).click();
  ...
  it('should be able to use arithmetic operations to update the display with result', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should disply "Not a number" if divided by zero', function () {
    running_total = element(by.css('#running_total'))
    element(by.css('#number5')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number0')).click();
